...
Crossway is an abstract strategy board game played on an $N \times N$ grid between two players: Black (X) and White (0).

- Black attempts to form a continuous chain connecting the North and South borders.
- White attempts to form a continuous chain connecting the West and East borders.
